...
\begin{minipage}[t]{0.68\textwidth}\raggedright
\code{pxweb_parse_response()}, \code{pxweb_as_data_frame()}\end{minipage}\\
Comments, codelists, and citation &
\begin{minipage}[t]{0.68\textwidth}\raggedright
\code{pxweb_codelists()}, \code{pxweb_data_comments()}, \code{pxweb_cite()}\end{minipage}\\
Predicates &
\begin{minipage}[t]{0.68\textwidth}\raggedright
\code{is.pxweb()}, \code{is_pxweb_response()}\end{minipage}\\
\hline
\end{tabular}
